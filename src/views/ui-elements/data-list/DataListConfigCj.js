...
import Sidebar from "./DataListSidebarCj"
    ...
    columns: [
      {
        ...
        sortable: true,
        cell: row => (
          <p title={row.nom} className="text-truncate text-bold-500 mb-0">
            {row.nom}
          </p>
        )
      },
      ...
      },
      {
        ...
        sortable: true,
        cell: row => (
          <p title={row.matricule} className="text-truncate text-bold-500 mb-0">
            {row.matricule}
          </p>
        )
      },
